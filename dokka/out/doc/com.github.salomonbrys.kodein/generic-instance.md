...
`inline fun <reified T : Any> `[`Builder`](-kodein/-builder/index.md)`.genericInstance(instance: T): `[`ProviderBinding`](-provider-binding/index.md)`<T>`
...
`inline fun <reified T : Any> `[`LazyKodeinAwareBase`](-lazy-kodein-aware-base/index.md)`.genericInstance(tag: Any? = null): <ERROR CLASS><T>`
...
`inline fun <reified T : Any> `[`CurriedLazyKodeinFactory`](-curried-lazy-kodein-factory/index.md)`<*>.genericInstance(tag: Any? = null): <ERROR CLASS><T>`
...
`inline fun <reified T : Any> `[`CurriedInjectorFactory`](-curried-injector-factory/index.md)`<*>.genericInstance(tag: Any? = null): <ERROR CLASS><T>`
