...
`inline fun <reified T : Any> `[`Builder`](../com.github.salomonbrys.kodein/-kodein/-builder/index.md)`.provider(noinline creator: (`[`Kodein`](../com.github.salomonbrys.kodein/-kodein/index.md)`) -> T): `[`ProviderBinding`](../com.github.salomonbrys.kodein/-provider-binding/index.md)`<T>`
...
`inline fun <reified T : Any> `[`CurriedInjectorFactory`](../com.github.salomonbrys.kodein/-curried-injector-factory/index.md)`<*>.provider(tag: Any? = null): <ERROR CLASS><`[`Provider`](../com.github.salomonbrys.kodein/-provider.md)`<T>>`
...
`inline fun <reified T : Any> `[`LazyKodeinAwareBase`](../com.github.salomonbrys.kodein/-lazy-kodein-aware-base/index.md)`.provider(tag: Any? = null): <ERROR CLASS><`[`Provider`](../com.github.salomonbrys.kodein/-provider.md)`<T>>`
...
`inline fun <reified T : Any> `[`CurriedLazyKodeinFactory`](../com.github.salomonbrys.kodein/-curried-lazy-kodein-factory/index.md)`<*>.provider(tag: Any? = null): <ERROR CLASS><`[`Provider`](../com.github.salomonbrys.kodein/-provider.md)`<T>>`
