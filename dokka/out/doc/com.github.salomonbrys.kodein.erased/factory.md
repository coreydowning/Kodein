...
`inline fun <reified A, reified T : Any> `[`Builder`](../com.github.salomonbrys.kodein/-kodein/-builder/index.md)`.factory(noinline creator: (`[`Kodein`](../com.github.salomonbrys.kodein/-kodein/index.md)`, A) -> T): `[`FactoryBinding`](../com.github.salomonbrys.kodein/-factory-binding/index.md)`<A, T>`
...
`inline fun <reified A, reified T : Any> `[`LazyKodeinAwareBase`](../com.github.salomonbrys.kodein/-lazy-kodein-aware-base/index.md)`.factory(tag: Any? = null): <ERROR CLASS><`[`Factory`](../com.github.salomonbrys.kodein/-factory.md)`<A, T>>`
